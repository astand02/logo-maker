...
describe('Triangle', () => {
    test('should render users personalized Triangle logo.', () => {
      ...
      expect(triangle.render()).toEqual(`<polygon width="300" height="200" points="150, 18 244, 182 56, 182" fill="${this.shapeColor}" />
      <text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`);
    });
  });
  ...
  describe('Square', () => {
    test('should render users personalized Square logo.', () => {
      ...
      expect(square.render()).toEqual(`<rect x="10" y="10" width="300" height="200" stroke="black" fill="${this.shapeColor}" stroke-width="5"/>
      <text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`);
    });
  });
